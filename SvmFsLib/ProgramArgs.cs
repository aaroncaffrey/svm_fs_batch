...
namespace SvmFsLib
{
    public class ProgramArgs
    {
        ...
        public string ResultsRootFolder = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? $@"C:\mmfs1\data\scratch\k1040015\SvmFs":$@"/mmfs1/data/scratch/k1040015/SvmFs";
