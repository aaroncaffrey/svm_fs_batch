    ...
    internal static class perf
    {
        ...
        internal class confusion_matrix
        {
            ...
            internal static confusion_matrix calculate_difference_value(confusion_matrix old_cm, confusion_matrix new_cm)
            {
                ...
                result.TP /= column_change;
                result.FP /= column_change;
                result.TN /= column_change;
                result.FN /= column_change;
                
                result.TPR /= column_change;
                result.TNR /= column_change;
                result.PPV /= column_change;
                result.Precision /= column_change;
                result.Prevalence /= column_change;
                result.MCR /= column_change;
                result.ER /= column_change;
                result.NER /= column_change;
                result.CNER /= column_change;
                result.Kappa /= column_change;
                result.Overlap /= column_change;
                result.RND_ACC /= column_change;
                result.Support /= column_change;
                result.BaseRate /= column_change;
                result.Youden /= column_change;
                result.NPV /= column_change;
                result.FNR /= column_change;
                result.FPR /= column_change;
                result.FDR /= column_change;
                result.FOR /= column_change;
                result.ACC /= column_change;
                result.GM /= column_change;
                result.F1S /= column_change;
                result.G1S /= column_change;
                result.MCC /= column_change;
                result.BM_ /= column_change;
                result.MK_ /= column_change;
                result.BAC /= column_change;
                result.ROC_AUC_Approx_All /= column_change;
                result.ROC_AUC_Approx_11p /= column_change;
                result.ROC_AUC_All /= column_change;
                result.PR_AUC_Approx_All /= column_change;
                result.PR_AUC_Approx_11p /= column_change;
                result.PRI_AUC_Approx_All /= column_change;
                result.PRI_AUC_Approx_11p /= column_change;
                result.AP_All /= column_change;
                result.AP_11p /= column_change;
                result.API_All /= column_change;
                result.API_11p /= column_change;
                result.Brier_All /= column_change;
                result.LRP /= column_change;
                result.LRN /= column_change;
                result.F1B_00 /= column_change;
                result.F1B_01 /= column_change;
                result.F1B_02 /= column_change;
                result.F1B_03 /= column_change;
                result.F1B_04 /= column_change;
                result.F1B_05 /= column_change;
                result.F1B_06 /= column_change;
                result.F1B_07 /= column_change;
                result.F1B_08 /= column_change;
                result.F1B_09 /= column_change;
                result.F1B_10 /= column_change;
                result.PPF_TP /= column_change;
                result.PPF_FP /= column_change;
                result.PPF_TN /= column_change;
                result.PPF_FN /= column_change;
                result.PPF_TPR /= column_change;
                result.PPF_TNR /= column_change;
                result.PPF_PPV /= column_change;
                result.PPF_Precision /= column_change;
                result.PPF_Prevalence /= column_change;
                result.PPF_MCR /= column_change;
                result.PPF_ER /= column_change;
                result.PPF_NER /= column_change;
                result.PPF_CNER /= column_change;
                result.PPF_Kappa /= column_change;
                result.PPF_Overlap /= column_change;
                result.PPF_RND_ACC /= column_change;
                result.PPF_Support /= column_change;
                result.PPF_BaseRate /= column_change;
                result.PPF_Youden /= column_change;
                result.PPF_NPV /= column_change;
                result.PPF_FNR /= column_change;
                result.PPF_FPR /= column_change;
                result.PPF_FDR /= column_change;
                result.PPF_FOR /= column_change;
                result.PPF_ACC /= column_change;
                result.PPF_GM /= column_change;
                result.PPF_F1S /= column_change;
                result.PPF_G1S /= column_change;
                result.PPF_MCC /= column_change;
                result.PPF_BM_ /= column_change;
                result.PPF_MK_ /= column_change;
                result.PPF_BAC /= column_change;
                result.PPF_ROC_AUC_Approx_All /= column_change;
                result.PPF_ROC_AUC_Approx_11p /= column_change;
                result.PPF_ROC_AUC_All /= column_change;
                result.PPF_PR_AUC_Approx_All /= column_change;
                result.PPF_PR_AUC_Approx_11p /= column_change;
                result.PPF_PRI_AUC_Approx_All /= column_change;
                result.PPF_PRI_AUC_Approx_11p /= column_change;
                result.PPF_AP_All /= column_change;
                result.PPF_AP_11p /= column_change;
                result.PPF_API_All /= column_change;
                result.PPF_API_11p /= column_change;
                result.PPF_Brier_All /= column_change;
                result.PPF_LRP /= column_change;
                result.PPF_LRN /= column_change;
                result.PPF_F1B_00 /= column_change;
                result.PPF_F1B_01 /= column_change;
                result.PPF_F1B_02 /= column_change;
                result.PPF_F1B_03 /= column_change;
                result.PPF_F1B_04 /= column_change;
                result.PPF_F1B_05 /= column_change;
                result.PPF_F1B_06 /= column_change;
                result.PPF_F1B_07 /= column_change;
                result.PPF_F1B_08 /= column_change;
                result.PPF_F1B_09 /= column_change;
                result.PPF_F1B_10 /= column_change;
                result.PPG_TP /= column_change;
                result.PPG_FP /= column_change;
                result.PPG_TN /= column_change;
                result.PPG_FN /= column_change;
                result.PPG_TPR /= column_change;
                result.PPG_TNR /= column_change;
                result.PPG_PPV /= column_change;
                result.PPG_Precision /= column_change;
                result.PPG_Prevalence /= column_change;
                result.PPG_MCR /= column_change;
                result.PPG_ER /= column_change;
                result.PPG_NER /= column_change;
                result.PPG_CNER /= column_change;
                result.PPG_Kappa /= column_change;
                result.PPG_Overlap /= column_change;
                result.PPG_RND_ACC /= column_change;
                result.PPG_Support /= column_change;
                result.PPG_BaseRate /= column_change;
                result.PPG_Youden /= column_change;
                result.PPG_NPV /= column_change;
                result.PPG_FNR /= column_change;
                result.PPG_FPR /= column_change;
                result.PPG_FDR /= column_change;
                result.PPG_FOR /= column_change;
                result.PPG_ACC /= column_change;
                result.PPG_GM /= column_change;
                result.PPG_F1S /= column_change;
                result.PPG_G1S /= column_change;
                result.PPG_MCC /= column_change;
                result.PPG_BM_ /= column_change;
                result.PPG_MK_ /= column_change;
                result.PPG_BAC /= column_change;
                result.PPG_ROC_AUC_Approx_All /= column_change;
                result.PPG_ROC_AUC_Approx_11p /= column_change;
                result.PPG_ROC_AUC_All /= column_change;
                result.PPG_PR_AUC_Approx_All /= column_change;
                result.PPG_PR_AUC_Approx_11p /= column_change;
                result.PPG_PRI_AUC_Approx_All /= column_change;
                result.PPG_PRI_AUC_Approx_11p /= column_change;
                result.PPG_AP_All /= column_change;
                result.PPG_AP_11p /= column_change;
                result.PPG_API_All /= column_change;
                result.PPG_API_11p /= column_change;
                result.PPG_Brier_All /= column_change;
                result.PPG_LRP /= column_change;
                result.PPG_LRN /= column_change;
                result.PPG_F1B_00 /= column_change;
                result.PPG_F1B_01 /= column_change;
                result.PPG_F1B_02 /= column_change;
                result.PPG_F1B_03 /= column_change;
                result.PPG_F1B_04 /= column_change;
                result.PPG_F1B_05 /= column_change;
                result.PPG_F1B_06 /= column_change;
                result.PPG_F1B_07 /= column_change;
                result.PPG_F1B_08 /= column_change;
                result.PPG_F1B_09 /= column_change;
                result.PPG_F1B_10 /= column_change;
